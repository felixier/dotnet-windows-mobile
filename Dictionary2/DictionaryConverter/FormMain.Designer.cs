namespace DictionaryConverter
{
	partial class FormMain
	{
		...
		private void InitializeComponent()
		{
			...
			this.checkBoxRemDup = new System.Windows.Forms.CheckBox();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			this.dictFileOut.Location = new System.Drawing.Point(209, 209);
			this.dictFileOut.Name = "dictFileOut";
			this.dictFileOut.Size = new System.Drawing.Size(157, 13);
			this.dictFileOut.TabIndex = 8;
			this.dictFileOut.Text = "!Languages names must be set!";
			// 
			// convertButton
			// 
			...
			this.label5.Text = "(Same folder as dictionary text file)";
			// 
			// checkBoxRemDup
			// 
			this.checkBoxRemDup.AutoSize = true;
			this.checkBoxRemDup.Checked = true;
			this.checkBoxRemDup.CheckState = System.Windows.Forms.CheckState.Checked;
			this.checkBoxRemDup.Location = new System.Drawing.Point(12, 178);
			this.checkBoxRemDup.Name = "checkBoxRemDup";
			this.checkBoxRemDup.Size = new System.Drawing.Size(117, 17);
			this.checkBoxRemDup.TabIndex = 10;
			this.checkBoxRemDup.Text = "Remove duplicates";
			this.checkBoxRemDup.UseVisualStyleBackColor = true;
			// 
			// FormMain
			// 
			...
			this.Controls.Add(this.checkBoxRemDup);
		...
		private System.Windows.Forms.CheckBox checkBoxRemDup;
	}
}
